...
- [ ] **Step 1: Modify `newPluginRegistry` signature**
...
- [ ] **Step 2: Update the `pluginDirFromSource` call**
...
- [ ] **Step 1: Add `--plugins` flag to build command**
...
- [ ] **Step 2: Pass the flag value to `newPluginRegistry` in `runBuild`**
...
- [ ] **Step 1: Add `--plugins` flag to dev command**
...
- [ ] **Step 2: Pass the flag value to `newPluginRegistry` in `runDev`**
...
- [ ] **Step 1: Update `TestNewPluginRegistry_UnknownPluginSilentlySkipped`**
...
- [ ] **Step 2: Update `TestNewPluginRegistry_EmptyPluginsMap`**
