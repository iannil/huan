...
// This is a self-contained copy of internal/plugin/plugin.go for plugin isolation.
package plugin
...
// (Deployer, Translator, etc.) embed Plugin and add methods.
//
...
// Find returns all registered plugins implementing capability T.
...
// SortedNames returns registered plugin names in lexicographic order.
